...
# Weekly options: DTE=7 on entry Fridays. Allow 5–9 to handle holiday-shortened weeks
# (Thursdays before long weekends have DTE=8, Wednesdays have DTE=9).
# This restricts the cleaned dataset to entry-day-only observations.
MIN_DTE = 5
MAX_DTE = 9
MONEYNESS_BAND = 0.20

ATM_DELTA_BAND = 0.10
CONSTANT_MATURITY_DAYS = 30
VARIANCE_SWAP_STRIKE_BAND = 0.05
...
SIGNAL_ZSCORE_ENTRY = 1.0
SIGNAL_LOOKBACK = 252
HEDGE_FREQUENCY = "daily"
TRANSACTION_COST_BPS = 5
POSITION_HOLD_DAYS = 5
MAX_HOLD_DAYS_WEEKLIES = 5
STOP_LOSS_PCT = 0.25
...
PLOT_NEUTRAL = "#4a4a4a"
PLOT_POSITIVE = "#2d7d2d"
PLOT_NEGATIVE = PLOT_COLORS["600"]
