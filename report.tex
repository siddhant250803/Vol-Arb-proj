...
\noindent The entire 95\% confidence interval lies above zero, and the probability of a positive Sharpe exceeds 100.0\%, providing strong statistical evidence that the observed performance is not attributable to sampling variation alone (Figure~\ref{fig:bootstrap}).
